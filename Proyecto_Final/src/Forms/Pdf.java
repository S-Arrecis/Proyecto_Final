...
public class Pdf {
    ...
    private PdfPTable tablaR = new PdfPTable(8);
    ...
    public void iniciarRecibo(){
        tablaR.addCell("Codigo");
        tablaR.addCell("Punto de Entrega");
        tablaR.addCell("Codigo Empleado");
        tablaR.addCell("Nombre Empleado");
        tablaR.addCell("Nombre Cliente");
        tablaR.addCell("Celular Cliente");
        tablaR.addCell("Serie Bicicleta");
        tablaR.addCell("Fotografia Cliente");
        //tablaEntrega.addCell("Codigo QR");
    }
...
//            documento.add(parrafo1);
            ...
            tablaR.addCell(codigo);
            tablaR.addCell(punto);
            
            
            tablaR.addCell(codigoEmpleado);
            tablaR.addCell(nombreEmpleado);
            tablaR.addCell(nombre);
            tablaR.addCell(numero);
            tablaR.addCell("WAKANDA"+serie);
            tablaR.addCell(Foto);
            documento.add(tablaR);
...
//            parrafo1.add("\n\n     Fecha: ");
     ...
     public void GenerarFormularioRecibo(String Hora ,String codigo,String punto,String nombreEmpleado, String codigoEmpleado, String nombre, String dpi, String numero, String direccion, String foto, String serie, String fotoBici){
        ...
        try{
            ...
            //String ruta = System.getProperty("user.home");
            PdfWriter.getInstance(documento,new FileOutputStream("FormularioRecibo.pdf"));
            //PdfWriter.getInstance(documento,new FileOutputStream(ruta + "/Desktop/Clientes.pdf"));
            Image cabeza = Image.getInstance(String.format( "src/img/header.png"));
//            Image Foto = Image.getInstance(String.format(foto));
//            Foto.scaleToFit(25,100);
